...
# -*- coding: utf-8 -*-
"""
测试小红书笔记详情 API - 使用搜索获取的 xsec_token
步骤：
1. 先搜索获取笔记列表和 xsec_token
2. 使用获取的 xsec_token 请求笔记详情
"""
...
def get_note_detail(note_id: str, xsec_token: str):
    ...
    # 关键参数：source_note_id + xsec_token
    payload = {
...
if __name__ == "__main__":
    # 使用之前搜索到的笔记 ID 和 xsec_token
    # 从 test_xhshow_search.py 的响应中获取
    test_note_id = "69635d04000000000b00996b"
    test_xsec_token = "ABsx0ZpbDH4yyYBkR95YLx6jOuRXRa0RnwWLSX7E1Rkyw="
    
    success = get_note_detail(test_note_id, test_xsec_token)
