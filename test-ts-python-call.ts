#!/usr/bin/env node
/**
 * 测试 TypeScript 调用 Python 脚本（完全复制 xiaohongshu-search.ts 的代码）
 */
...
// 完全复制 xiaohongshu-search.ts 中的 Python 脚本
const pythonScript = `
import json
import sys
import time
...
console.log('=== 测试 TypeScript 调用 Python ===\n');

const pythonExecutable = '/opt/homebrew/bin/python3.10';
