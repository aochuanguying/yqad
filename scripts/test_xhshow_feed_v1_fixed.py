#!/usr/bin/env python3
"""
测试使用 xhshow 调用 v1 版本的 feed API（修正参数格式）
...
def test_feed_v1_fixed():
    """测试 v1 feed API - 修正参数格式"""
    print("=" * 60)
    ...
    # 准备请求数据 - 使用单个 source_note_id
    payload = {
        "source_note_id": "680e1e94000000001203f9ae",
        "image_formats": ["jpg", "webp", "avif"],
        "extra": {"need_body_topic": "1"}
    }
    
    print(f"\n请求笔记 ID: {payload['source_note_id']}")
