...
- [x] 7.1 为搜索词选择器编写单元测试（覆盖三个平台）
- [x] 7.2 为提示词构建器编写单元测试（覆盖三个平台）
- [x] 7.3 为平台选择算法编写单元测试（覆盖各种场景）
- [x] 7.4 为图片选择器编写单元测试（覆盖三个平台）
- [x] 7.5 进行集成测试，验证整个发帖流程
- [x] 7.6 进行 A/B 测试，对比优化前后的发帖效果
- [x] 7.7 验证数据库配置更新的热加载功能

## 8. 文档和部署

- [x] 8.1 编写数据库迁移说明文档
- [x] 8.2 编写配置管理接口 API 文档
- [x] 8.3 更新 README.md，说明新增的分平台优化功能
