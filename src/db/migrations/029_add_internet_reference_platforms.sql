...
CREATE TABLE IF NOT EXISTS internet_reference_platforms (
  ...
  search_script VARCHAR(100) DEFAULT NULL COMMENT '搜索脚本名称（已废弃，使用 TypeScript 实现）',
...
VALUES
  ('xiaohongshu', '小红书', 1, 10, 1.00, NULL, 10, '高质量生活方式分享社区，适合用车生活、露营装备内容'),
  ('zhihu', '知乎', 1, 8, 0.80, NULL, 10, '专业问答社区，深度内容，适合用车知识、技术解析'),
  ('autohome', '汽车之家', 1, 7, 0.60, NULL, 8, '专业汽车社区，垂直领域，适合车型对比、改装案例'),
  ('dongchedi', '懂车帝', 0, 7, 0.60, NULL, 8, '汽车资讯社区，新车评测、用车心得'),
  ('mafengwo', '马蜂窝', 0, 6, 0.50, NULL, 6, '旅游攻略社区，自驾路线、露营地点'),
  ('smzdm', '什么值得买', 0, 6, 0.50, NULL, 6, '购物分享社区，汽车用品、露营装备评测')
